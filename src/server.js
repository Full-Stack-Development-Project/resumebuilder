...
app.post('/results',(req,res)=>{
    ...
    console.log(query)
    request('https://api.adzuna.com/v1/api/jobs/gb/search/1?app_id=9cdb076f&app_key=0ea8d71490d67cd8d24e5820ffab76cb&results_per_page=20&what='+query+'&content-type=application/json',(error,response,body)=>{
        if(error){
            console.log(error)
        }
